/*////    Modified version of the ivy Version thats suitable for use in Eclipse: plugins and features       .
 * 
 * 
 * 
 * 
...
/**
 *   Modified version of the ivy Version class thats suitable for use for     Eclipse: plugins and features       .
...
public class Version implements Comparable/* <Version> */{
	...
	public boolean equivalentTo(Version other) {
	...
	public boolean compatibleTo(Version other) {
//		equivalent - dependent plug-in version must be at least at the version specified, or at a higher service level (major and minor version levels must equal the specified version).
		int diff = major - other.major;
        if (diff != 0) {
            return false;
        }
       int diffminor = minor - other.minor;
        if (diffminor < 0) {
            return false;
        }	
       diff = patch - other.patch;
        if (  diffminor==0 &&	 diff < 0) {
            return false;
        }
        return    true;
	}
